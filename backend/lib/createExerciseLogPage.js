...
// // not working
// Page.prototype.findInputAndButton = async function () {
//     descriptionInput = await this.findThroughId("descriptionLabel");
...
//         // const searchButtonText = await searchButton.getAttribute('value');
//         // const searchInputEnableFlag = await searchInput.isEnabled();
//         // const descriptionInputText = await descriptionInput.isEnabled();
//         const dateLable = await dateLabel.isDate();
//         console.log(" dateLable is ", await dateLable.isDate());
//
//         // console.log(" descriptionInputText is ", await descriptionInput.isEnabled());
//
//         return {
//             // inputEnabled: searchInputEnableFlag,
